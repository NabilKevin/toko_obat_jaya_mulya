...
class Get extends Controller
{
    public function index()
    {
      ...
      $penjualanHariIni = (clone $transaksis)->whereDate('transaction.created_at', Carbon::today())->sum('subtotal');
      $penjualanKemarin = (clone $transaksis)->whereDate('transaction.created_at', Carbon::yesterday())->sum('subtotal');
      ...
      $totalItemTerjualHariIni = (clone $transaksis)->whereDate('transaction.created_at', Carbon::today())->count();
      $totalItemTerjualKemarin = (clone $transaksis)->whereDate('transaction.created_at', Carbon::yesterday())->count();
