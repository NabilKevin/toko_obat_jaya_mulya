...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    ...
    <section class="order-2 lg:order-1 lg:col-span-2 flex flex-col gap-4">
        ...
        <div class="rounded-lg border border-neutral-200 dark:border-neutral-800 
            ...
            <div class="flex flex-col gap-2">
                <input id="search" name="search"
                    placeholder="Masukkan nama obat/kode barcode..."
                    class="h-10 rounded-md border border-neutral-200 dark:border-neutral-800 
                           bg-white dark:bg-neutral-900 px-3 text-sm focus:ring-2 focus:ring-primary"/>
        ...
        <div class="rounded-lg border border-neutral-200 dark:border-neutral-800 
            ...
            <div id="tableObats"
                 class="divide-y divide-neutral-100 dark:divide-neutral-800 overflow-y-auto px-2">
                @foreach ($obats as $obat)
                    <div class="flex items-center justify-between px-2 py-4">
                        ...
                        <button data-id="{{ $obat['id'] }}"
                            class="btn-tambah text-sm px-3 py-1.5 rounded-md border border-neutral-200 
...
<div id="previewCamera" 
     class="fixed z-50 inset-0 hidden bg-black/50 flex items-center justify-center">
    <div id="reader" 
         class="w-[90%] max-w-[400px] bg-white rounded-md overflow-hidden shadow-lg">
    </div>
</div>
